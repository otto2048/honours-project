                                ...
                                <div class="col-sm">
                                    ...
                                    <div class="row  pt-1 pb-1 ">
                                        <div class="col-8">
                                            ...
                                            <button type="button" disabled aria-disabled=true class="btn btn-dark theme debugger-control debugger-live-control d-none ms-1" id="pause-btn" aria-label="Pause"><span class="mdi mdi-pause"></span></button>
                                            <button type="button" disabled aria-disabled=true class="btn btn-dark theme debugger-control debugger-live-control d-none ms-1" id="stop-btn" aria-label="Stop"><span class="mdi mdi-stop"></span></button>
                                            <button type="button" disabled aria-disabled=true class="btn btn-dark theme debugger-control debugger-live-control d-none ms-1" id="restart-btn" aria-label="Restart"><span class="mdi mdi-restart"></span></button>
                                        </div>
                                        <div class="col-4">
                                            <div class="float-end">
                                                <button type="button" disabled aria-disabled=true class="btn btn-dark theme debugger-control debugger-live-control d-none ms-1" id="step-into-btn" aria-label="Step into"><span class="mdi mdi-arrow-down"></span></button>
                                                <button type="button" disabled aria-disabled=true class="btn btn-dark theme debugger-control debugger-live-control d-none ms-1" id="step-over-btn" aria-label="Step over"><span class="mdi mdi-arrow-down-right"></span></button>
                                                <button type="button" disabled aria-disabled=true class="btn btn-dark theme debugger-control debugger-live-control d-none ms-1" id="step-out-btn" aria-label="Step out"><span class="mdi mdi-arrow-up"></span></button>
                                            </div>
                                        </div>
                                    </div>
