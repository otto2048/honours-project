...
export const EVENT_ON_INFERIOR_EXIT = "EVENT_ON_PROG_EXIT";
export const EVENT_ON_LOCALS_DUMP = "EVENT_ON_LOCALS_DUMP";
export const EVENT_ON_DUMP_LOCAL = "EVENT_ON_DUMP_LOCAL";
export const EVENT_ON_TOP_LEVEL_VARIABLES = "EVENT_ON_TOP_LEVEL_VARIABLES";
...
export {OP_COMPILE, OP_INPUT, OP_TEST,
        ...
        EVENT_ON_BREAKPOINT_CHANGED, EVENT_ON_TEST_FAILURE, EVENT_ON_TEST_SUCCESS,
